...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#fef9f5] text-[#3d2b1f] font-sans">
      {/* Nav */}
      <nav className="backdrop-blur-sm sticky top-0 z-50 border-b border-[#f0ddd0] bg-[#ffffff] text-[#3d2b1f]">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            >
              ...
              <p className="text-sm mb-4 text-[#806b60] bg-[transparent]">{item.desc}</p>
      ...
      {/* Preview */}
      <section className="py-16 bg-[#fcfaf8] text-[#3d2b1f]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#f0ddd0] max-w-2xl mx-auto">
            <div className="inline-block text-xs font-bold px-3 py-1 rounded-full mb-4 border-t-[#d48a9b] border-r-[#d48a9b] border-b-[#d48a9b] border-l-[#d48a9b] text-[#ffa8aa] bg-[#ffeeee]">
              {days[activeDay].day}
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-xl p-4 border-t-[1px] border-r-[1px] border-b-[1px] border-l-[1px] text-[#3d2b1f] bg-[#faf3ef] border-t-[#ead2c7] border-r-[#ead2c7] border-b-[#ead2c7] border-l-[#ead2c7]">
                <p className="font-bold mb-1 text-[#c4856a] bg-[transparent] text-[16px]">媽媽溫柔提醒</p>
                <p className="text-sm text-[#806b60]">{days[activeDay].reminder}</p>
              </div>
              <div className="rounded-xl p-4 bg-[#fafaf9] border-t-[#e7e5e4] border-r-[#e7e5e4] border-b-[#e7e5e4] border-l-[#e7e5e4] border-t-[1px] border-r-[1px] border-b-[1px] border-l-[1px]">
                <p className="font-bold mb-1 text-[#78716c] bg-[transparent] text-[16px]">AI 回應示範</p>
                <p className="text-sm text-[#806b60]">{days[activeDay].aiResponse}</p>
              </div>
              <div className="rounded-xl p-4 bg-[#fffafa] border-t-[#ffeaea] border-r-[#ffeaea] border-b-[#ffeaea] border-l-[#ffeaea] border-t-[1px] border-r-[1px] border-b-[1px] border-l-[1px]">
      ...
      <section className="py-16 text-center bg-[#fcf5f3] text-[#3d2b1f]">
        <div className="max-w-3xl mx-auto px-6 bg-[#ffffff] text-[#3d2b1f] rounded-tl-[30px] rounded-tr-[30px] rounded-br-[30px] rounded-bl-[30px] pt-[30px] pb-[30px]">
          <h2 className="text-2xl font-bold mb-4 text-[#806b60] bg-[transparent] mt-[0px] rounded-tl-[0px] rounded-tr-[0px] rounded-br-[0px] rounded-bl-[0px] border-t-[#ffffff] border-r-[#ffffff] border-b-[#ffffff] border-l-[#ffffff] pb-[0px] border-t-[0px] border-r-[0px] border-b-[0px] border-l-[0px] pt-[0px]">溫柔，是最好的陪伴</h2>
          <p className="mb-2 text-[#806b60]">陪伴不在於時間長短，而在於那份全然的專注。</p>
          <p className="mb-8 text-[#806b60]">願這七天，成為您與孩子心中最柔軟的記憶。</p>
          <a
            href="https://line.me"
            target="_blank"
            rel="noopener noreferrer"
