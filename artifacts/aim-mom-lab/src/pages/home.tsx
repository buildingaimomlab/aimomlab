  ...
  return (
    <div className="min-h-screen bg-[#fef9f5] text-[#3d2b1f] font-sans">
      ...
      <section className="py-16 text-center bg-[#fcf5f3] text-[#3d2b1f]">
        <div className="max-w-3xl mx-auto px-6 bg-[#ffffff] text-[#3d2b1f] rounded-tl-[30px] rounded-tr-[30px] rounded-br-[30px] rounded-bl-[30px] pt-[20px] pb-[20px]">
          <h2 className="text-2xl font-bold mb-4 text-[#806b60] bg-[transparent] mt-[0px] rounded-tl-[0px] rounded-tr-[0px] rounded-br-[0px] rounded-bl-[0px] border-t-[#ffffff] border-r-[#ffffff] border-b-[#ffffff] border-l-[#ffffff] pt-[15px] pb-[0px] border-t-[0px] border-r-[0px] border-b-[0px] border-l-[0px]">溫柔，是最好的陪伴</h2>
