    ...
    <div className="min-h-screen bg-[#fef9f5] text-[#3d2b1f] font-sans">
      ...
      <section className="bg-[#fff5ee] py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-2xl font-bold text-center mb-3 text-[#3d2b1f]">計畫特色</h2>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-2/3">
            <h2 className="text-2xl font-bold mb-6 text-[#3d2b1f]">AI媽媽研究室</h2>
            <div className="space-y-4 text-[#7a5c4a] leading-relaxed">
